...
class Algorithms {
    ...
    ///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        ...
        static int find(int vertex, int* parent) { // finding the representative of a vertices group
    ...
    /////////////////////////////////////////////////////////////////////////////////////////////
        static void union_sets(int u, int v, int* parent) { // unite two groups of vertices
    ...
    /////////////////////////////////////////////////////////////////////////////////////////////////////////
        static Graph dfs(Graph& graph, int start) {
            ...
            //check if it's a valid graph and start vertex
            if (start < 0 || start >= vertices) {
                throw std::invalid_argument("קודקוד התחלה מחוץ לטווח");
            }
            if (vertices == 0) {
                throw std::invalid_argument("הגרף ריק");
            }
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    static Graph kruskal(Graph& graph) {
        ...
        for (int i = 0; i < edgeIndex; ++i) { // run through all sorted edges
            int u = edges[i][0]; // קודקוד u
            int v = edges[i][1]; // קודקוד v
            int weight = edges[i][2]; // משקל הצלע
